  ...
  return (
    <div className='flex justify-center text-2xl p-10 my-10 text-green-800'>
      <form onSubmit={onSubmit} className=' w-1/2 p-20 border-2 rounded-3xl border-green-400' >
        <h1 className='w-full text-center text-7xl font-bold mb-10'>Sign up</h1>
        <div>
        ...
        <button className='block w-full h-20 font-semibold mx-auto mt-20 p-4 bg-green-600 hover:bg-green-500 rounded-lg text-white'>Sign up</button>
      </form>
    </div>
  );
};